...
const EVENT_CATEGORY_VALIDATOR_SCHEMA = z.object({
  name: CATEGORY_NAME_VALIDATOR,
  color: CATEGORY_COLOR_VALIDATOR,
  emoji: z.string().emoji("Invalid emoji").optional(),
})
type EventCategoryForm = z.infer<typeof EVENT_CATEGORY_VALIDATOR_SCHEMA>
...
const CreateEventCategoryModal = ({
  ...
  const {
    ...
    resolver: zodResolver(EVENT_CATEGORY_VALIDATOR_SCHEMA),
  })
